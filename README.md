...
In order to compile and test this, you will need these packages:


Debian:
`sudo apt install clang nasm binutils qemu-system-x86`

Arch:
`sudo pacman -S clang nasm binutils qemu-full`
